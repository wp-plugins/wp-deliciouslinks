 ...
 * $LastChangedBy$
 */
class d6vCode_Project extends d6vCode_Base
{
	//--- filename
	...
	{
		$fs = new d6vCode_FS ( $this->application () , $this->home () );
		$files = $fs->dir ( "*.*" , d6vCode_FS::type_file , 999 );
		//return array('/volumes/Code/www/local/wp-content/plugins/sandbox/library/d6vCode/Loader.php');
		return $files;
	}
