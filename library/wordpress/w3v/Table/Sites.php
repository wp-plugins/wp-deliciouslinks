<?php
class w3v_Table_Sites extends w3v_Table
{
		...
		if (! $this->exists_by_domain ( $domain , $path ))
		{
			...
			if ($site_id)
			{
				...
				$options = array (
					...
					$prime_site_meta = new w3v_Table_SiteMeta ( 1 );
					$new_site_meta = new w3v_Table_SiteMeta ( $site_id );
	...
	{
		$wp_sitemeta = new w3v_Table_SiteMeta ( );
