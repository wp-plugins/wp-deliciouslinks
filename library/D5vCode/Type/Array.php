 ...
 * $LastChangedBy$
 */
class D5vCode_Type_Array extends D5vCode_Type_Abstract implements Iterator, ArrayAccess, Serializable, Countable
{
	...
	private function convert ()
	{
		foreach ($this->value as $key => $value) {
			if (is_array($value)) {
				$this->value[$key] = new D5vCode_Type_Array($this->application(),$value);
			}
		}
	}
	// iterator functions
