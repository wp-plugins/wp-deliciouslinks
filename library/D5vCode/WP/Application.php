 ...
 * $LastChangedBy$
 */
if (! class_exists ( 'D5vCode_WP_Application' ))
:
	require_once dirname ( dirname ( __FILE__ ) ) . DIRECTORY_SEPARATOR . 'Application.php';
	class D5vCode_WP_Application extends D5vCode_Application
	{
		...
		public function preload_classes ( $classes = array() )
		{
			...
			array_unshift($classes,
				 'D5vCode_WP_Application' , 'D5vCode_WP_Values' , 'D5vCode_WP_Mysql'  , 'D5vCode_WP_Image' , 'D5vCode_WP_Table' , 'D5vCode_WP_Sites' , 'D5vCode_WP_Site' , 'D5vCode_WP_SiteMeta' , 'D5vCode_WP_Posts' , 'D5vCode_WP_Blogs' , 'D5vCode_WP_Blog' , 'D5vCode_WP_Options' , 'D5vCode_WP_Users' , 'D5vCode_WP_UserMeta'
		);
