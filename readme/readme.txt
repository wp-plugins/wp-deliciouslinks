...
Tags: php5.2, sync, synchronize
Requires at least: 3.0.0
Tested up to: 3.1
Stable tag: 4.0.3
Easily synchronize the links list on your blog or multiple
...
DeliciousLinkSync is written by <a href='http://dcoda.co.uk'>dcoda</a>
...
The settings screen contain inbuilt help boxes however you can post support your questions  [here](http://wordpress.org/tags/wp-deliciouspost?forum_id=10)  
